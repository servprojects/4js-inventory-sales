  ...
  componentDidMount() {
    ...
    Http.get(`${this.api}`)
      .then((response) => {
        ...
        console.log("response.data.persmission")

        var perm = [];
        var perm = JSON.parse(response.data.header[0].permission);
        console.log(perm)

        var fp = perm.find(e => e == 'PRNT_SALES_REP')
        console.log("fp")
        console.log(fp)
                ...
                <ul class="navbar-nav mr-auto">
                  ...
                  <li className={classNames('nav-item dropdown', {
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <Link to="/direct/transfer"> <a class="dropdown-item" href="#">Direct Transfer</a></Link>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                       {/* permission */}
                      {permission.find(e => e == 'PRNT_SALES_REP') ?
                      ...
                      {/* <Link to={{ pathname: `/report/sales`, state: { type: "Sale" , path:"/report/sales"} }}><a class="dropdown-item" href="#">Direct Sales</a></Link> */}
