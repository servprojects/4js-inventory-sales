          ...
          <div className="container">
            <div className="row">
              <div className="section-login col-lg-6 ml-auto mr-auto">
                ...
                <div className="card-login card mb-3 shadow-2xl" style={{border: "none"}}>
                  <div className="card-body ">
                    <center>
                      <div>
                      <img src="/images/logo.png" style={{width: "70%"}} alt="AJ's Builders" />
                        {/* <h2>4J's Builders</h2>
                        <p>
                          Construction Supply
                          {' '}
                    ...
                    >
                      <div className="form-group">
                        <label htmlFor="email" style={inpt_length}>
                          Email Address 
                          <input
                            id="email"
                            type="email"
                      ...
                      <div className="form-group">
                        <label htmlFor="password" style={inpt_length}>
                          Password
                          <input
                            id="password"
                            type="password"
