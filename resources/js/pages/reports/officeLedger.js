...
class OfficeLedger extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  buttonFormatter = (cell, row) => {
    ...
    return (
      ...
      <div>
        <center>
          <Link to={{ pathname: '/specOfficeLedger', state: { id: row.id, path: '/specOfficeLedger' } }}><button type="button" class="btn btn-primary"  > Ledger </button></Link>
        </center>
      </div>
    )
  }
    ...
    return (
      <div className="contentTransact">
        ...
        >
          ...
          <TableHeaderColumn dataField='id' isKey={true} dataFormat={this.buttonFormatter} width="130" ></TableHeaderColumn>
...
export default connect(mapStateToProps)(OfficeLedger);
