...
class CustomerLedger extends Component {
  ...
  buttonFormatter = (cell, row) => {
    ...
    return (
      ...
      <div>
        <center>
        <Link to={{ pathname: '/specCustomerLedger', state: { id: row.id , path: '/specCustomerLedger' } }}><button type="button" class="btn btn-primary"  > Ledger </button></Link>
</center>
      </div>
    )
  }
    ...
    return (
      <div className="contentTransact">
        ...
        >
          ...
          {/* <TableHeaderColumn dataField="id" >Buttons</TableHeaderColumn> */}
        </BootstrapTable>
        {this.state.upIdItem}
      </div>
    );
