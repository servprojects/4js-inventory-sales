...
class RequestItemExist extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
    ...
    Http.post(`/api/v1/requestindex`, subs)
      .then((response) => {
        ...
        if (this._isMounted) {
          ...
          } else if (response.data.requests[0].request_status == "Requested") {
            this.setState({
  ...
  addReqItem = (property) => {
    ...
    Http.post(this.api, property)
      .then(({ data }) => {
        ...
        if (this._isMounted) {
          this.setState({ reqitems: data.updated, unit_price: null, 
            // quantity: null,
             item_id: null, new_item: null, });
        }
        this.addForm.reset();
        if (this._isMounted) {
          this.setState({ loading: false });
  ...
  reset = (e) => {
    ...
    if (this._isMounted) {
      this.setState({
        urgency_status: null, estimated_receiving_date: null, type: null, size: null, unit_name: null, branch_id: null, item_id: null,
        set_max: null,
      });
    }
  ...
  <h1>Content to print!</h1>
        ...
        <div class="leftcolumn add_req">
          ...
          <div style={dis} >
            ...
            <center>  <h3>Add Item for transfer</h3> </center>
            <br />
            <p><i>*The first digit of numbers represents the item balance of the branch you have requested</i></p>
            <br />
                    ...
                    <tr>
                      <td>
                        <center>
                          ...
                          <input id="addRequest" min="1" max={this.state.set_max} type="number" name="quantity" class="form-control mb-2 mr-sm-2" style={req_inpt} onBlur={this.handleChange} />
                  ...
                  <table style={req_tab}>
                    ...
                    <tr>
                      <td>
                        <center>
                          <label style={label}>Quantity</label><br />
                          <input id="addRequest" type="number" name="quantity" class="form-control mb-2 mr-sm-2" style={req_inpt} onBlur={this.handleChange} />
        ...
        <div class="contentwrapper_new">
          <div >
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#exe">Items</a>
              </li>
              {/* <li class="nav-item">
                ...
                <div>
                  ...
                  <div className="todos">
                    ...
                    >
                      ...
                      <TableHeaderColumn dataField="item_size" width="100" >Size</TableHeaderColumn>
                                ...
                                <td>
                                  <div style={dis}>
                                    ...
                                    >
                                      <i class='fas icons' onClick={this.deleteItem}
                                        data-key={itemex.id}
                                        data-keyreq={itemex.requisition_id}>&#xf1f8;</i>
                                    </button>
...
export default connect(mapStateToProps)(RequestItemExist);
