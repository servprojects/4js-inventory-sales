...
class ApprovalRequestItem extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  // Approvals
  render() {
    const { units, reqnewitems, reqitems, allitems, reqDetails, data, error, loading, res } = this.state;
    ...
    return (
      <div className="contentreq">
            ...
            <div class="tab-content">
              ...
              <div id="exe" class="container tab-pane active"><br />
                ...
                <div>
                  ...
                  >
                    <TableHeaderColumn tdStyle={{ whiteSpace: 'normal' }} thStyle={{ whiteSpace: 'normal' }} dataField='item' isKey={true}>Name</TableHeaderColumn>
                    <TableHeaderColumn dataField='item_size' width="80">Size</TableHeaderColumn>
                    <TableHeaderColumn dataField='original_price' width="100">Est. Price</TableHeaderColumn>
                    ...
                    <TableHeaderColumn dataField="status" width="110">Status</TableHeaderColumn>
                  </BootstrapTable>
              ...
              <div id="new" class="container tab-pane fade"><br />
                ...
                <div>
                  ...
                  // options={options} exportCSV
                  >
                    <TableHeaderColumn tdStyle={{ whiteSpace: 'normal' }} thStyle={{ whiteSpace: 'normal' }} dataField='new_item' isKey={true}>Name</TableHeaderColumn>
                    ...
                    <TableHeaderColumn dataField='unit_price' width="80">Est. Price</TableHeaderColumn>
                    <TableHeaderColumn dataField="quantity" width="80">Quantity</TableHeaderColumn>
                    <TableHeaderColumn dataField="sub_total" width="80">Total</TableHeaderColumn>
        ...
        {reqitems.map((itemex) => (<p class="disb">{overtotal += itemex.sub_total}</p>))}
        {reqnewitems.map((itemex) => (<p class="disb">{overtotal += itemex.sub_total}</p>))}
...
export default connect(mapStateToProps)(ApprovalRequestItem);
